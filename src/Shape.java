...
public abstract class Shape
{
	...
	public int depth=99; // depth of object
	public boolean isSelected=false;
	public String objName;
	public List<Port> portsPosition=new ArrayList<>();
	public int fontAlign; // for string alignment
	
	// note: abstract method can only be defined by an abstract class
	...
	// if line can be covered, it should be changed
	public Rectangle getOwnShape()
	{
