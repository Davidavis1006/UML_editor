...
public class Line
{
	...
	public int x3, y3, x4, y4=0; // used in AssociationLine, GeneralizationLine and CompositionLine
	...
	// Reference: https://blog.csdn.net/xidiangejun/article/details/5525241
	// drawAL and rotateVec function
	public void draw(Graphics2D graphics2D)
	{
		Point startPoint=startPort.point1; // int startX, int startY
		Point endPoint=endPort.point1; // int endX, int endY
	...
	// Reference: http://2017cg.blogspot.com/2017/10/20171005.html
